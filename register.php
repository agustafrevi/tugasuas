<?php
	...
	mysql_select_db("web", $Koneksi);
	// Make the query:
	mysql_query("INSERT INTO web.biodata(nama,". "tanggal_lahir, alamat,jenis_kelamin, no_telp)". 
	"values ('$fn', '$ln', '$e','$jk', '$n' )");
	...
	<p>Tanggal Lahir : <input type="date" name="tanggal_lahir" size="15" maxlength="40" value="<?php if (isset($_POST['tanggal_lahir'])) echo $_POST['tanggal_lahir']; ?>" /> (Tanggal-Bulan-Tahun)</p>
	<p>Alamat : <input type="text" name="alamat" size="20" maxlength="60" value="<?php if (isset($_POST['alamat'])) echo $_POST['alamat']; ?>" /> </p>
	<p>Jenis Kelamin : <input type="text" name="jenis_kelamain" size="10" maxlength="20" value="<?php if (isset($_POST['jenis_kelamin'])) echo $_POST['jenis_kelamin']; ?>" /> (Pria / Wanita)</p>
	...
	<b><u><a href="viewbiodata.php">Lihat data user</a></u></b>
	</form>
	<?php 
	include ('includes/footer.html');
	?>
